...
// ספק נתוני הטיסות הפעיל — נשמר ב-localStorage. 'gf'=Google Flights (חדש) · 'old'=Skyscanner (ישן). ברירת מחדל: Google Flights (הספק המתוקן והמוכח).
let FLIGHT_PROVIDER=(localStorage.getItem('tf_provider')||'gf');
